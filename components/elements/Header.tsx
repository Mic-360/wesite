...
const Header: NextComponentType<NextPageContext, {}, Props> = (
  ...
  return (
    <div
      id='view'
      className='absolute top-0 left-0 z-10 h-full overflow-hidden bg-transparent'
    >
      <div className='uppercase cursor-default justify-center items-center'>
        <AnimatedTitle
          text='Twinverse'
          className='text-5xl sm:text-6xl md:text-8xl lg:text-[10rem] xl:text-[12rem] font-medium tracking-tightest font-archivo text-plume pl-3.5'
        />
      </div>
